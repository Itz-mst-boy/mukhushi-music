...
import config
from HeroMusic import Carbon, YouTube, app
from HeroMusic.core.call import Hero
from HeroMusic.misc import db
from HeroMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from HeroMusic.utils.exceptions import AssistantErr
from HeroMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from HeroMusic.utils.inline.playlist import close_markup
from HeroMusic.utils.pastebin import Herobin
from HeroMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Hero.force_stop_stream(chat_id)
