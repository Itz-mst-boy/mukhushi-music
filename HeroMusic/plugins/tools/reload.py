...
from HeroMusic.utils.database import get_authuser_names, get_cmode
from HeroMusic.utils.decorators import language, AdminActual, ActualAdminCB
from HeroMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Hero.stop_stream(message.chat.id)
    except:
        pass
