...
from HeroMusic.utils import (Herobin, get_channeplayCB,
                              seconds_to_min)
from HeroMusic.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from HeroMusic.utils.decorators.language import language, languageCB
from HeroMusic.utils.inline import queue_back_markup, queue_markup
